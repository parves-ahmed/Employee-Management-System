...
SECRET_KEY = 'o6xvqp!xs1ed8t97pdf0z8*2(s7lz_xgi$z5$3j&mr$9l+$1=&'
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,
        'DIRS': [
            os.path.join(BASE_DIR, 'employee_management_system', 'templates'),
        ],
        'OPTIONS': {
            'context_processors': [
                ...
                'polls.context_processors.poll_count',
            ],
        },
    },
]
